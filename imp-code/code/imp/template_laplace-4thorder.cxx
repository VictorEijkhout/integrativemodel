...
int main(int argc,char **argv) {
  ...
  auto 
    elements =
    shared_ptr<object>( new mpi_object(elements_dist); elements->set_name("elements") ),
    local_nodes =
    shared_ptr<object>( new mpi_object(local_nodes_dist); local_nodes->set_name("local_nodes") ),
    global_nodes =
    shared_ptr<object>( new mpi_object(global_nodes_dist); global_nodes->set_name("global nodes") );
   ...
   */
  shared_ptr<kernel> nodes_to_elements;
