...
void masked_reduction_1d( kernel_function_args ) {
  ...
  int dim = outdistro->get_orthogonal_dimension();
  index_int nclusters = outdistro->volume(p);
  ...
  MPI_Allreduce(indata.data(),outdata.data(),1,dim1_type,masked_add,MPI_COMM_WORLD);
